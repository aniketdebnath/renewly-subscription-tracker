    ...
    <table cellpadding="0" cellspacing="0" border="0" width="100%" style="background-color: #ffffff; border-radius: 10px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
        <tr>
            <td style="background-color: #4a90e2; text-align: center; padding: 20px;">
                <p style="font-size: 32px; font-weight: bold; color: white; margin: 0;">Renewly Subscription Tracker</p>
            </td>
        </tr>
        <tr>
            <td style="padding: 40px 30px;">
                ...
                <p style="font-size: 16px; margin-bottom: 25px;">
                  ${
                    isWelcomeEmail
                      ? `Welcome to <strong>Renewly Subscription Tracker</strong>! 🎉 Your subscription for <strong>${subscriptionName}</strong> has been successfully added.`
                      : `Your <strong>${subscriptionName}</strong> subscription is set to renew on <strong style="color: #4a90e2;">${renewalDate}</strong> (${daysLeft} days from today).`
                  }
                </p>
                ...
                <p style="font-size: 16px; margin-bottom: 25px;">
                  ${
                    isWelcomeEmail
                      ? `We’ll notify you before your next renewal date on <strong>${renewalDate}</strong>.`
                ...
                <p style="font-size: 16px; margin-top: 30px;">
                    Best regards,<br>
                    <strong>The Renewly Team</strong>
                </p>
            </td>
        </tr>
        <tr>
            <td style="background-color: #f0f7ff; padding: 20px; text-align: center; font-size: 14px;">
                <p style="margin: 0 0 10px;">
                    Renewly Inc. | Melbourne, Victoria, Australia
                </p>
                <p style="margin: 0;">
...
export const emailTemplates = [
  {
    label: "Welcome to Renewly",
    generateSubject: () => "🎉 Welcome to Renewly Subscription Tracker!",
    generateBody: (data) =>
      generateEmailTemplate({ ...data, isWelcomeEmail: true }),
  },
  {
